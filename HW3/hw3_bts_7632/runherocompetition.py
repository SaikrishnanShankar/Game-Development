...
b1 = Base(BASE, (75, 75), world, 1, WanderingHumanMinion, MyHumanHero, HumanHunter2 if not issubclass(MyHumanHero, MyHero) else None, BUILDRATE, 1000000)
world.addBase(b1)


b2 = Base(BASE, (1125, 1125), world, 2, WanderingAlienMinion, MyAlienHero, AlienHunter2 if not issubclass(MyAlienHero, MyHero) else None, BUILDRATE, 1000000)
world.addBase(b2)
