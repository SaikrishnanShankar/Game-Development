...
home = Place("home", "at_home", (475, 350), 100, 100, world, color=(0, 0, 255), linewidth=4)
home.possible_triggers = [take_bath, dry_off]
store = Place("store", "at_store", (650, 400), 100, 100, world, color=(255, 0, 255), linewidth=4)
store.possible_triggers = [buy_gun, buy_ammo, load_gun]
bank = Place("bank", "at_bank", (800, 600), 100, 100, world, color=(255, 0, 0), linewidth=4)
bank.possible_triggers = [rob_bank, load_gun]
forest = Place("forest", "at_forest", (800, 100), 100, 100, world, color=(0, 255, 0), linewidth=4)
