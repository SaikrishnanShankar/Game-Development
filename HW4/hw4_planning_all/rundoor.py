...
open_blue_door = Action('open_blue_door', 
                         ...
                         add_list = ['path_blue_door_to_table', 'path_table_to_blue_door'], 
...
open_red_door = Action('open_red_door', 
                         ...
                         add_list = ['path_red_door_to_chest', 'path_chest_to_red_door'], 
...
actions = [pickup_blue_key, open_blue_door, pickup_red_key, open_red_door, pickup_gold, 
           move_bed_to_blue_door, move_blue_door_to_table, move_table_to_red_door, 
           move_red_door_to_chest, move_chest_to_red_door, move_table_to_blue_door,
           move_blue_door_to_bed, move_red_door_to_table]
